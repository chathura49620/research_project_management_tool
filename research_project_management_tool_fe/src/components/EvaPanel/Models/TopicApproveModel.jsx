...
export class TopicApproveModel extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event, props) {
        ...
        fetch('http://localhost:5000/api/topic-details-update', {
            method: 'PUT',
            headers: {
            ...
            body: JSON.stringify({
                ...
                status: 'Approve',
                groupLeaderEmail:this.props.email
            })
        })
            .then(res => res.json())
            .then((result) => {
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="note">
                                        ...
                                        <Form.Control type="text" name="note" required placeholder="Note" />
                                    </Form.Group>
                                    <br></br>
                                    <Form.Group>

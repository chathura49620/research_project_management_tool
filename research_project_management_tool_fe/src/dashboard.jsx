        ...
        return (
          <div>
            ...
            <Route
              ...
              exact
              component={AddTopicDetailsForm1}
            ></Route>
            <Route
            ...
            <Route
              ...
              exact
              component={AddFirstStudentDetails}
            ></Route>
            <Route
              path="/stuGroup-registration-2"
              exact
              component={AddSecondStudentDetails}
            ></Route>
            <Route
              path="/stuGroup-registration-3"
              exact
              component={AddThirdStudentDetails}
            ></Route>
            <Route
              path="/stuGroup-registration-4"
              exact
              component={AddFourthStudentDetails}
            ></Route>
            <Route
              path="/topic-registration-2"
              exact
              component={AddTopicDetailsForm2}
            ></Route>
            <Route
              path="/email-sending"
              exact
